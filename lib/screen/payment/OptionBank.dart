...
class OptionPayment extends ConsumerStatefulWidget {
  OptionPayment({
    super.key,
    this.set_phone,
    this.up_point,
  ...
  @override
  ConsumerState<OptionPayment> createState() => _OptionPaymentState();
}

class _OptionPaymentState extends ConsumerState<OptionPayment> {
  ...
  List Qr_Image = [
    {
      'image': 'assets/images/ABA_Logo.png',
    },
    {
