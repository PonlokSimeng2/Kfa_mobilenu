...
class PdfApi {
  static Future<File> generateCenterdText(String text) async {
    ...
    return saveDocument(name: 'ma_example', pdf: pdf);
  }
  ...
  static Future<File> generateParagrap() async {
    final pdf = Document();

    pdf.addPage(MultiPage(
        pageFormat: PdfPageFormat.a4,
        build: (context) => <Widget>[
              SvgImage(svg: 'assets/images/New_KFA_Logo.png'),
              Header(child: Text('My HeaderLine')),
